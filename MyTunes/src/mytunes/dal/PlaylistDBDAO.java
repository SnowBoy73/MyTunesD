...
//        allSongs = songDBDao.getAllSongsFromDB();  // NEEDS CONNECTION
...
System.out.print(":  songId's "); //
   ...
   //             Song playlistSong = songDBDao.getSong(songId); // NEEDS CONNECTION
System.out.print(", " + songId); //
 //               playlistSongs.add(playlistSong);  // NEEDS CONNECTION
                i++;
            }
